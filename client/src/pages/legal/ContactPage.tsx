                    ...
                    <Stack spacing={1.2}>
                        <Typography sx={{ color: '#5C3D2E' }}>
                            ...
                            <Link
                                ...
                                underline="hover"
                                sx={{ color: '#8A6A2B', fontWeight: 600, transition: 'color 0.2s', '&:hover': { color: '#9A7833' } }}
                            >
                                {contactEmail}
                            </Link>
                        </Typography>
                        ...
                        <Typography sx={{ color: '#5C3D2E' }}>
                            <strong>שם העסק:</strong> WedFlow
                        </Typography>

                        <Typography sx={{ color: '#5C3D2E' }}>
                            <strong>שעות פעילות:</strong> ימים א׳–ה׳, בין השעות 09:00–18:00
                        </Typography>
                    </Stack>
                </Paper>
            </Container>
