                ...
                >
                    ...
                    <Stack spacing={1.2}>
                        <Typography sx={{ color: '#5C3D2E', lineHeight: 1.8 }}>
                            אם ברצונכם למחוק את חשבונכם ואת כלל המידע המשויך אליו, ניתן לשלוח אלינו בקשה באמצעות דוא"ל.
                        </Typography>

                        <Typography sx={{ color: '#5C3D2E', lineHeight: 1.8 }}>
                            לצורך אימות הבקשה, יש לציין את שמכם המלא, שם האירוע (במידת האפשר) ופרטי התקשרות.
                        </Typography>
