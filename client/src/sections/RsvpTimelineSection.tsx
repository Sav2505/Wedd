...
const steps = [
    { when: '30 יום לפני', text: 'אישור הגעה נשלח אוטומטית לכל אורח בוואטסאפ' },
    { when: '7 ימים לפני', text: 'תזכורת עדינה נשלחת רק למי שעדיין לא השיב' },
    { when: 'יום לפני', text: 'תזכורת אחרונה יוצאת לכלל האורחים' },
