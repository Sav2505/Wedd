...
const items = [
    ...
    },
    {
        ...
        text: `אנחנו יודעים שחתונה זו הוצאה גדולה.. מטרתינו היא להקל עליכם ולתת לכם כלי איכותי ומתקדם הכולל בתוכו את כל מה שאתם צריכים לארגון החתונה, במחיר סמלי של ${import.meta.env.VITE_PRICING} ש"ח בלבד !`,
    },
    {
        emoji: '⏰',
