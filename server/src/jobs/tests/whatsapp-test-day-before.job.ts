...
import { buildTemplateComponents, BuildTemplateComponentsInput, sendTemplateMessageWithRetry, TEMPLATE_TO_TAB_INDEX, type SupportedWeddingTemplate } from '../../services/whatsapp.service';
...
export async function runOneOffTestSendToDan(): Promise<void> {
    ...
    for (const guest of confirmedGuests) {
        ...
        try {
            ...
            const tabIndex = TEMPLATE_TO_TAB_INDEX['wedding_day_before'];
...
export function scheduleOneOffTestSendToday1230DayBefore(): void {
